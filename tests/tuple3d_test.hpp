...
TEST(Tuples, Adding)
{
    ...
    Ray_Tracer::Tuple3D::Tuple3D<int> tup_value = tuple1 + tuple2;
...
TEST(Tuple, Negation)
{
    ...
    Ray_Tracer::Tuple3D::Tuple3D<int> tup_value = -tup;
...
TEST(Tuple3D, Multiply1)
{
    ...
    Ray_Tracer::Tuple3D::Tuple3D<float> tup_value = tup * multiplier;
...
{
    Ray_Tracer::Tuple3D::Tuple3D<float> tup1 = {1.f, 2.f, 3.f, 4.f};

    Ray_Tracer::Tuple3D::Tuple3D<float> tup_value = tup1.normalize();
    float answer_x = 1.f / std::sqrt(30);
    float answer_y = 2.f / std::sqrt(30);
    float answer_z = 3.f / std::sqrt(30);
    float answer_w = 4.f / std::sqrt(30);

    Ray_Tracer::Tuple3D::Tuple3D<float> tup_answer = {answer_x, answer_y, answer_z, answer_w};
